                        ...
                        <div class="grids">
                            ...
                            <form id="basic-form" method="post">
                                <div class="form-group" style="padding-top: 20px">
                                        <input style="width: 250px; display: inline;" id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Search">
                            ...
                            <div class="form-body">
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    ...
                                                    $sql="SELECT hrs_tbluser.*,hrs_tblbooking.BookingNumber,hrs_tblbooking.ID,hrs_tblbooking.Status,hrs_tblbooking.BookingDate from hrs_tblbooking join hrs_tbluser on hrs_tblbooking.UserID=hrs_tbluser.ID where hrs_tblbooking.BookingNumber like '$sdata%' or hrs_tblbooking.Status like '$sdata%' or hrs_tbluser.FullName like '$sdata%' LIMIT $offset, $no_of_records_per_page";
